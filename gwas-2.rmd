...
#' A function for simple mean imputation of continous SNP data
...
# FIXME: This needs to be run again (need a second try)
mean_imputed_dat <- rules_imputed@.Data %>%
  # as.data.frame() %>%
  mutate(across(.cols = all_of(to_impute),
                .fns = imputed_mean))
