...
## [SNP Testing - marginal approach](marginal_analysis.html)

SNP testing gets down the results which are the "featured presentation": associated loci for our phenotypes of interest. This approach examines associations between the outcome and a single SNP (a "one SNP at a time" approach). 

## [SNP Testing - joint approach](joint_analysis.html)

It is often of interest to consider more complex relationships between SNPs and a clinical outcome (phenotype). This section outlines a regression approach, allowing us to consider associations with multiple SNPs. 
