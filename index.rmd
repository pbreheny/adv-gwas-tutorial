...
## [SNP Test](docs/marginal_analysis.html)

SNP testing gets down the results which are the "featured presentation": associated loci for our phenotypes of interest. This is straightforward if we complete the prior two sections correctly.
