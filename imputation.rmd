...
This tells us that `r any_missing` out of `r ncol(snp_stats)` SNPs still have some missing values (albeit less than 10\%.) The average call rate is `r mean(call_rates) |> round(3)` -- this high call rate is a good sign, affirming the quality of our data. 
